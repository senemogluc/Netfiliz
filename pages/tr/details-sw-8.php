...
<head>
  ...
  <section class="movie-detail">
        ...
        <?php
                ...
                $sql = "SELECT * FROM `moviedetails` WHERE `movieName` LIKE 'Star Wars: The Last Jedi'";
          ...
          <div class="movie-detail-content">
            <h1 class="h1 detail-title">
              <?php echo "Yıldız Savaşları: Son Jedi" ?>
            </h1>
            ...
            <p class="storyline">
            <?php echo "Star Wars destanı, yeni kahramanlar ve galaktik efsaneler destansı bir maceraya atılırken, Güç'ün gizemlerini ve geçmişin şok edici ifşaatlarını açığa çıkarırken devam ediyor."?>
            </p>
            <?php }
              ?>
