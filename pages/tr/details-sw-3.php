...
<head>
  ...
  <section class="movie-detail">
        ...
        <?php
                ...
                $sql = "SELECT * FROM `moviedetails` WHERE `movieName` LIKE 'Star Wars: Revenge of the Sith'";
          ...
          <div class="movie-detail-content">
            <h1 class="h1 detail-title">
              <?php echo "Yıldız Savaşları: Sith'in İntikamı" ?>
            </h1>
            ...
            <p class="storyline">
            <?php echo "Klon Savaşları'nın üç yılında, Obi-Wan yeni bir tehdidin peşine düşerken Anakin, Şansölye Palpatine tarafından galaksiyi yönetmek için uğursuz bir komplonun içine çekilir."?>
            </p>
            <?php }
              ?>
