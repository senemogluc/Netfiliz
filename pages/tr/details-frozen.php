...
<head>
  ...
  <section class="movie-detail">
        ...
        <?php
                ...
                $sql = "SELECT * FROM `moviedetails` WHERE `movieName` LIKE 'Frozen'";
          ...
          <div class="movie-detail-content">
            ...
            <p class="storyline">
            <?php echo "Yeni taç giymiş Kraliçe Elsa yanlışlıkla gücünü kullanarak her şeyi buza çevirerek sonsuz kışta evini lanetleyince, kız kardeşi Anna hava durumunu değiştirmek için bir dağ adamı, onun şakacı ren geyiği ve bir kardan adamla iş birliği yapar."?>
            </p>
            <?php }
              ?>
