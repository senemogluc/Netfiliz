...
<head>
  ...
  <section class="movie-detail">
        ...
        <?php
                ...
                $sql = "SELECT * FROM `moviedetails` WHERE `movieName` LIKE 'Star Wars: Return of the Jedi'";
          ...
          <div class="movie-detail-content">
            <h1 class="h1 detail-title">
              <?php echo "Yıldız Savaşları: Jedi'ın Dönüşü" ?>
            </h1>
            ...
            <p class="storyline">
            <?php echo "Han Solo'yu Jabba the Hutt'tan kurtardıktan sonra Asiler ikinci Ölüm Yıldızını yok etmeye çalışırken Luke, Darth Vader'ın karanlık taraftan dönmesine yardım etmeye çalışır."?>
            </p>
            <?php }
              ?>
