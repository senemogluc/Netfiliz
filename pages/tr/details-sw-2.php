...
<head>
  ...
  <section class="movie-detail">
        ...
        <?php
                ...
                $sql = "SELECT * FROM `moviedetails` WHERE `movieName` LIKE 'Star Wars: Attack of the Clones'";
          ...
          <div class="movie-detail-content">
            <h1 class="h1 detail-title">
              <?php echo "Star Wars: Klon Savaşları" ?>
            </h1>
            ...
            <p class="storyline">
            <?php echo "İlk karşılaşmalarından on yıl sonra Anakin Skywalker, Padmé Amidala ile yasak bir aşk yaşarken Obi-Wan Kenobi, Jedi'lar için hazırlanmış gizli bir klon ordusunu keşfeder."?>
            </p>
            <?php }
              ?>
