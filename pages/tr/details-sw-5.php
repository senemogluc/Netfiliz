...
<head>
  ...
  <section class="movie-detail">
        ...
        <?php
                ...
                $sql = "SELECT * FROM `moviedetails` WHERE `movieName` LIKE 'Star Wars: The Empire Strikes Back'";
          ...
          <div class="movie-detail-content">
            <h1 class="h1 detail-title">
              <?php echo "Yıldız Savaşları: İmparatorun Dönüşü" ?>
            </h1>
            ...
            <p class="storyline">
            <?php echo "Asiler İmparatorluk tarafından alt edildikten sonra Luke Skywalker, Yoda ile Jedi eğitimine başlarken, arkadaşları Darth Vader ve ödül avcısı Boba Fett tarafından galakside takip ediliyor."?>
            </p>
            <?php }
              ?>
